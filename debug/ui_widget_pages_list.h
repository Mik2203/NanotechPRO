...
public:
    ...
    void setupUi(QWidget *widget_pages_list)
    {
        ...
        widget_pages_list->resize(301, 100);
        QSizePolicy sizePolicy(QSizePolicy::Expanding, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(widget_pages_list->sizePolicy().hasHeightForWidth());
        ...
        sizePolicy.setHeightForWidth(fr_add_list_0->sizePolicy().hasHeightForWidth());
        fr_add_list_0->setSizePolicy(sizePolicy);
        fr_add_list_0->setMinimumSize(QSize(301, 100));
        fr_add_list_0->setFrameShape(QFrame::NoFrame);
        ...
        sizePolicy.setHeightForWidth(fr_genirals_0->sizePolicy().hasHeightForWidth());
        fr_genirals_0->setSizePolicy(sizePolicy);
        fr_genirals_0->setMinimumSize(QSize(0, 50));
        ...
        sizePolicy.setHeightForWidth(fr_pages_0->sizePolicy().hasHeightForWidth());
        fr_pages_0->setSizePolicy(sizePolicy);
        fr_pages_0->setMinimumSize(QSize(0, 50));
        ...
        sizePolicy1.setHeightForWidth(fr_add_pages_0->sizePolicy().hasHeightForWidth());
        fr_add_pages_0->setSizePolicy(sizePolicy1);
        fr_add_pages_0->setMinimumSize(QSize(45, 45));
...
""));
        ...
        gridLayout_15->addWidget(fr_add_pages_0, 0, 7, 1, 1);

        horizontalSpacer_8 = new QSpacerItem(7, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_15->addItem(horizontalSpacer_8, 0, 9, 2, 1);
        ...
        fr_list_1->setMinimumSize(QSize(60, 45));
        ...
        lineE_page_1->setMinimumSize(QSize(55, 16));
        lineE_page_1->setMaximumSize(QSize(55, 16));
...
""));
        ...
        gridLayout_15->addWidget(fr_list_1, 0, 2, 1, 1);
        ...
        fr_list_2->setMinimumSize(QSize(60, 45));
        ...
        lineE_page_2->setMinimumSize(QSize(55, 16));
        lineE_page_2->setMaximumSize(QSize(55, 16));
...
""));
        ...
        gridLayout_15->addWidget(fr_list_2, 0, 4, 1, 1);
        ...
        fr_list_3->setMinimumSize(QSize(60, 45));
        ...
        lineE_page_3->setMinimumSize(QSize(55, 16));
        lineE_page_3->setMaximumSize(QSize(55, 16));
...
""));
        ...
        gridLayout_15->addWidget(fr_list_3, 0, 6, 1, 1);
        ...
        fr_list_0->setMinimumSize(QSize(60, 45));
        ...
        lineE_page_0->setMinimumSize(QSize(55, 16));
        lineE_page_0->setMaximumSize(QSize(55, 16));
...
""));
        ...
        gridLayout_15->addWidget(fr_list_0, 0, 1, 1, 1);
